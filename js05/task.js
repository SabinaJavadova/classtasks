...
// let f = milks.find((element)=> {
//  return element.id===1;
// })
// console.log(f);

// TASK 1.3 : FatPercent-in ədədi ortasını çıxarın. Bunu FatAverage adlı funksiya ilə edin.
//  Funksiya həmin arrayi parametr kimi qəbul edəcək, ədədi ortanı qaytaracaq.

// const fatP = milks.reduce((sum,item)=>sum+item.FatPercent,0)/milks.length;

// console.log(fatP);

// Task 1.4 : yağlılıq faizi 3-dən yuxarı olan milk-ləri arraydə göstərin. Funksiya yazın

// const yagliliq = milks.find((element) => element.FatPercent >=3)
...
// const fat = milks.reduce((sum,item) =>{
...
// const expensive = milks.find((element)=>element.id ==2)
// console.log(expensive);
// Task 1.8 : ən baha milkin adını qaytaran funksiya yazın. Arrayi parametr kimi qəbul etsin.

// const f = milks.find((element)=>{
//   let max = milks[0].price
...
// const sum = products.reduce((cem,element)=>{
...
// const categMen = products.filter((element)=>{
//   if (element.category==="men's clothing") {
//     return element
//   }
// })
// console.log(categMen);
...
const count = products.every((element)=>element.rating.count>100);
console.log(count);

// #category'si "electronics" olanların qiymətini 50% endirin
// const sale = products.filter((element)=>{
